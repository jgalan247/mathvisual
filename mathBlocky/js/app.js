...
const CATS=[
  ...
  {id:"ratios",label:"▥ Ratios",color:"#10b981",mode:"ratio"},
...
function switchMode(mode){
  ...
  document.getElementById("ratioMode").style.display=mode==="ratio"?"flex":"none";
  ...
  if(mode==="ratio")setTimeout(function(){updateRatioExplorer()},60);
...
document.addEventListener("DOMContentLoaded",function(){
  ...
  initTrigExplorer();initRatioExplorer();initEquationBalance();initQuadratic();initSOH();initFractions();
